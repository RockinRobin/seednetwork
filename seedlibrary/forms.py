...
class ExtendedGrainForm(SeedNetworkBaseForm):
	...
	other_traits=forms.CharField(label="Uses", widget=forms.Textarea(attrs={'rows':'5', 'cols':'60'}), required=False, help_text="Livestock feed? Straw for bedding? Broom-making? etc.")
